...
function FloatingContacts() {
  ...
  const Item = ({ href, bg, title, children, delay = 0, onClick }) => (
    <a
      href={href}
      target="_blank"
  ...
  return (
    <div className="fixed right-4 z-50" style={{ bottom: bottomOffset }}>
      ...
      <div
        ...
        `}
      >
        <Item href={phoneUrl} bg={BRAND.colors.pink} title="โทร" onClick={() => trackPhoneClick('floating_contacts')}>
        ...
        <Item href={lineUrl} bg={BRAND.colors.line} title="LINE" delay={60} onClick={() => trackOutboundClick(lineUrl, 'LINE', { source: 'floating_contacts' })}>
          <Image
            fetchPriority="high"
            src="/line-icon.webp"
            alt="LINE"
        ...
        {igUrl && (
          <Item href={igUrl} bg="#ffffff" title="Instagram" delay={120} onClick={() => trackOutboundClick(igUrl, 'Instagram', { source: 'floating_contacts' })}>
        ...
        {tiktokUrl && (
          <Item href={tiktokUrl} bg="#000000" title="TikTok" delay={180} onClick={() => trackOutboundClick(tiktokUrl, 'TikTok', { source: 'floating_contacts' })}>
